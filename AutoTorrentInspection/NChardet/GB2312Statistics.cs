namespace NChardet
{
    public class GB2312Statistics : EUCStatistics
    {
        ...
        _mFirstByteStdDev = 0.020081f; // Lead Byte StdDev
        _mFirstByteMean   = 0.010638f; // Lead Byte Mean
        _mFirstByteWeight = 0.586533f; // Lead Byte Weight
        ...
        _mSecondByteStdDev = 0.014156f; // Trail Byte StdDev
        _mSecondByteMean   = 0.010638f; // Trail Byte Mean
        _mSecondByteWeight = 0.413467f; // Trial Byte Weight
        }
